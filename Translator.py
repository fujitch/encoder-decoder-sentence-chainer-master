...
class Translator(chainer.Chain):
    def __init__(self, debug = False, source = 'words_random_order20181018.txt', target = 'sentence_random_order20181018.txt', embed_size = 200):
